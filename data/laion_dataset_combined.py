...
class LaionDataset_Combined(Dataset):
    def __init__(self, split: str, preprocess: callable):
        ...
        self.image_path_prefix = "/home/hle/bao/data/laion_cir_combined/"
        with open(data_file_path + "/files/laion_combined_new.json") as f:
            self.triplets = json.load(f)#[::4]
    ...
    def __getitem__(self, index):
        ...
        reference_caption = ""
        target_caption = ""
        return reference_image, relative_caption, target_image, reference_caption, target_caption
